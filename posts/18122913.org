...
=history.replaceState= 方法顾名思义，替换当前，被替换的部分丢弃，所以想不保留历史时用该方法。

** ref
[[https://medium.com/frontend-fun/js-vanilla-script-spa-1b29b43ea475][Js: Vanilla SPA – Frontend Fun – Medium]]
[[https://stackoverflow.com/questions/1397329/how-to-remove-the-hash-from-window-location-url-with-javascript-without-page-r][How to remove the hash from window.location (URL) with JavaScript without page refresh? - Stack Overflow]]
* Domain
...
当然这种冷冰冰的字符对 SEO 不友好，采用 =title + id= 的组合，title 不影响 routing
