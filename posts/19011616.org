...
foo.setValue("bb"); // OK, since it require something inferior to <? super String>, which is superior to String.
String s = foo.getValue(); // Error, incompatible type
...
[[https://docs.oracle.com/javase/tutorial/java/generics/bridgeMethods.html#bridgeMethods][Effects of Type Erasure and Bridge Methods]]
** Method Overloading
...
- /core java 10th/
- [[https://www.zhihu.com/question/28665443/answer/118148143][Java不能实现真正泛型的原因？ - 知乎]]
